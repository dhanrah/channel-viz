(function ( $ ){
	...
	*/
	...
	var defaultKey		= 'dw4L4VYRDdvmwI6V8o4K1TnigGds4Q545dj9kQxbeCavyHqF', // Unique master Xively API key to be used as a default
		defaultFeeds	= [714502515], // Comma separated array of Xively Feed ID numbers
		applicationName	= 'Sports Tackling Bot', // Replaces Xively logo in the header
		dataDuration	= '90days', // Default duration of data to be displayed // ref: https://xively.com/dev/docs/api/data/read/historical_data/
		dataInterval	= 10800, // Default interval for data to be displayed (in seconds)
		dataColor		= '0A1922', // CSS HEX value of color to represent data (omit leading #)
